...
## Descripción breve:
Análisis de curvas de luz del telescopio TESS con el fin de detectar eventos astrofísicos de interés mediante el uso de métodos  matemáticos, aprendizaje automático no supervisado y clustering.
